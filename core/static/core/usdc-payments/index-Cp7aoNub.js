import{aT as h,aQ as d,aF as c,aR as l,ay as x,aY as b,ax as g,aZ as v,aV as C,aN as m,aO as _,aP as $}from"./usdc-payments.js";import{c as w,r as T}from"./index-CEi207t0.js";import"./index-B2MxXlVi.js";const R=h``;var O=function(n,e,r,o){var i=arguments.length,t=i<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,r):o,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")t=Reflect.decorate(n,e,r,o);else for(var s=n.length-1;s>=0;s--)(a=n[s])&&(t=(i<3?a(t):i>3?a(e,r,t):a(e,r))||t);return i>3&&t&&Object.defineProperty(e,r,t),t};let f=class extends d{render(){const{termsConditionsUrl:e,privacyPolicyUrl:r}=c.state;return!e&&!r?null:l`
    ...
    `}howDoesItWorkTemplate(){return l` <wui-link @click=${this.onWhatIsBuy.bind(this)}>
      ...
      How does it work?
    </wui-link>`}onWhatIsBuy(){x.sendEvent({type:"track",event:"SELECT_WHAT_IS_A_BUY",properties:{isSmartAccount:b(g.state.activeChain)===v.ACCOUNT_TYPES.SMART_ACCOUNT}}),C.push("WhatIsABuy")}};f.styles=[R];f=O([w("w3m-onramp-providers-footer")],f);const P="https://reown.com",U=m`
  .reown-logo {
    height: 24px;
  }
