import{aN as U,aO as ye,aP as Se,aQ as x,aR as _,aS as C,aW as g,aT as l,a_ as I,bG as Pe,aZ as T,bH as Te,bI as w,az as O,bJ as ve,bK as N,aF as ie,aG as A,bL as ue,ax as m,bc as P,ay as j,aA as R,b3 as ke,bh as z,aK as _e,aL as Ce,aM as $e,b4 as S,aY as M,be as h,aU as Re,bM as be,aV as Oe}from"./wallet-connect.js";import"./wallet-connect-index-B6sr3y_3.js";import{U as Ue}from"./wallet-connect-index-CogVilYf.js";import"./wallet-connect-index-U3skagNC.js";import"./wallet-connect-index-CzEuXccK.js";import"./wallet-connect-index-7zQeXKWR.js";import"./wallet-connect-index-eKmRNwWR.js";import"./wallet-connect-index-DRhw5OpL.js";import{M as le}from"./wallet-connect-MathUtil-BGCe3rZ3.js";const Le=U`
  :host {
    position: relative;
  }
...
`;var W=function(t,e,n,s){var a=arguments.length,i=a<3?e:s===null?s=Object.getOwnPropertyDescriptor(e,n):s,o;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(t,e,n,s);else for(var u=t.length-1;u>=0;u--)(o=t[u])&&(i=(a<3?o(i):a>3?o(e,n,i):o(e,n))||i);return a>3&&i&&Object.defineProperty(e,n,i),i};const rt=3,ot=2,ct=.3,ut="200px",lt={"accent-primary":Re.tokens.core.backgroundAccentPrimary};let q=class extends C{constructor(){super(...arguments),this.rings=rt,this.duration=ot,this.opacity=ct,this.size=ut,this.variant="accent-primary"}render(){const e=lt[this.variant];this.style.cssText=`
    ...
    `}renderRing(e,n){const a=`animation-delay: ${e/n*this.duration}s;`;return l`<div class="pulse-ring" style=${a}></div>`}};q.styles=[ye,at];W([x({type:Number})],q.prototype,"rings",void 0);W([x({type:Number})],q.prototype,"duration",void 0);W([x({type:Number})],q.prototype,"opacity",void 0);W([x()],q.prototype,"size",void 0);W([x()],q.prototype,"variant",void 0);q=W([_("wui-pulse")],q);const fe=[{id:"received",title:"Receiving funds",icon:"dollar"},{id:"processing",title:"Swapping asset",icon:"recycleHorizontal"},{id:"sending",title:"Sending asset to the recipient address",icon:"send"}],we=["success","submitted","failure","timeout","refund"],dt=U`
  :host {
    display: block;
    height: 100%;
    width: 100%;
