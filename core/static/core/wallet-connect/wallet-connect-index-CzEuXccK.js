import{aN as h,aO as g,aP as y,aQ as i,aR as m,aS as b,aW as p,aT as s}from"./wallet-connect.js";const f=h`
  :host {
    width: 100%;
  }
...
`;var t=function(e,a,n,d){var l=arguments.length,r=l<3?a:d===null?d=Object.getOwnPropertyDescriptor(a,n):d,u;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")r=Reflect.decorate(e,a,n,d);else for(var c=e.length-1;c>=0;c--)(u=e[c])&&(r=(l<3?u(r):l>3?u(a,n,r):u(a,n))||r);return l>3&&r&&Object.defineProperty(a,n,r),r};let o=class extends b{constructor(){super(...arguments),this.type="primary",this.imageSrc="google",this.imageSize=void 0,this.loading=!1,this.boxColor="foregroundPrimary",this.disabled=!1,this.rightIcon=!0,this.boxed=!0,this.rounded=!1,this.fullSize=!1}render(){return this.dataset.rounded=this.rounded?"true":"false",this.dataset.type=this.type,s`
      <button
