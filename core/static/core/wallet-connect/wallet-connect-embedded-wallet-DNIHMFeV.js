import{aV as Y,aS as g,bh as W,aF as K,aT as c,b4 as _,bd as V,br as G,be as d,aR as w,aN as E,aO as U,aP as H,aQ as l,aE as N,ax as m,bs as j,a_ as k,a$ as A,b0 as h,aZ as L,bt as q,aW as X,bu as v,az as z,ay as O,aA as Q,aY as Z}from"./wallet-connect.js";import"./wallet-connect-index-CogVilYf.js";import{e as J,n as ee}from"./wallet-connect-ref-m3XXzk8j.js";import{H as I}from"./wallet-connect-HelpersUtil-D1aQBHA1.js";import"./wallet-connect-index-nKFq4XGN.js";import"./wallet-connect-index-U3skagNC.js";import"./wallet-connect-index-B6sr3y_3.js";import"./wallet-connect-index-dCBKkBlp.js";import"./wallet-connect-index-DDHBnAC-.js";import{N as te}from"./wallet-connect-NavigationUtil-DmfK5sOV.js";import"./wallet-connect-ConstantsUtil-COJBkkkj.js";const ie=Y`
  div {
    width: 100%;
  }
...
`;var y=function(e,t,i,r){var n=arguments.length,o=n<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,i):r,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(e,t,i,r);else for(var s=e.length-1;s>=0;s--)(a=e[s])&&(o=(n<3?a(o):n>3?a(t,i,o):a(t,i))||o);return n>3&&o&&Object.defineProperty(t,i,o),o};const ne={sm:"md-regular",md:"lg-regular",lg:"lg-regular"},ae={success:"sealCheck",error:"warning",warning:"exclamationCircle"};let u=class extends g{constructor(){super(...arguments),this.type="success",this.size="md",this.imageSrc=void 0,this.disabled=!1,this.href="",this.text=void 0}render(){return c`
    ...
    `}isV6(){return(j.get("dapp_smart_account_version")||"v6")==="v6"}toggleSmartAccountVersion(){j.set("dapp_smart_account_version",this.isV6()?"v7":"v6"),typeof window<"u"&&window?.location?.reload()}togglePreferredAccountTypeTemplate(){const t=this.network?.chainNamespace,i=m.checkIfSmartAccountEnabled(),r=_.getConnectorId(t);return!_.getAuthConnector()||r!==k.CONNECTOR_ID.AUTH||!i?null:(this.switched||(this.text=A(t)===h.ACCOUNT_TYPES.SMART_ACCOUNT?"Switch to your EOA":"Switch to your Smart Account"),c`
      <wui-list-item
        icon="swapHorizontal"
        ?rounded=${!0}
        ?chevron=${!0}
    ...
    `)}async changePreferredAccountType(){const t=this.network?.chainNamespace,i=m.checkIfSmartAccountEnabled(),r=A(t)===h.ACCOUNT_TYPES.SMART_ACCOUNT||!i?h.ACCOUNT_TYPES.EOA:h.ACCOUNT_TYPES.SMART_ACCOUNT;_.getAuthConnector()&&(this.loading=!0,await L.setPreferredAccountType(r,t),this.text=r===h.ACCOUNT_TYPES.SMART_ACCOUNT?"Switch to your EOA":"Switch to your Smart Account",this.switched=!0,q.resetSend(),this.loading=!1,this.requestUpdate())}};C([d()],$.prototype,"loading",void 0);C([d()],$.prototype,"switched",void 0);C([d()],$.prototype,"text",void 0);C([d()],$.prototype,"network",void 0);$=C([w("w3m-smart-account-settings-view")],$);const ce=E`
  :host {
    width: 100%;
  }
