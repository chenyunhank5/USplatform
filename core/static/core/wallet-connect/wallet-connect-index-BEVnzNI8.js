import{aN as g,aS as f,aY as u,aT as e,ay as P,be as y,aR as b,aO as k,aQ as w,aW as v,aP as A}from"./wallet-connect.js";import"./wallet-connect-index-DRU8Kqe1.js";import{H as x}from"./wallet-connect-HelpersUtil-D1aQBHA1.js";import"./wallet-connect-index-dCBKkBlp.js";import"./wallet-connect-index-7zQeXKWR.js";const I=g`
  :host {
    display: block;
  }
...
`;var $=function(t,a,n,r){var s=arguments.length,i=s<3?a:r===null?r=Object.getOwnPropertyDescriptor(a,n):r,o;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(t,a,n,r);else for(var c=t.length-1;c>=0;c--)(o=t[c])&&(i=(s<3?o(i):s>3?o(a,n,i):o(a,n))||i);return s>3&&i&&Object.defineProperty(a,n,i),i};let p=class extends f{constructor(){super(...arguments),this.resizeObserver=void 0,this.unsubscribe=[],this.status="hide",this.view=u.state.view}firstUpdated(){this.status=x.hasFooter()?"show":"hide",this.unsubscribe.push(u.subscribeKey("view",a=>{this.view=a,this.status=x.hasFooter()?"show":"hide",this.status==="hide"&&document.documentElement.style.setProperty("--apkt-footer-height","0px")})),this.resizeObserver=new ResizeObserver(a=>{for(const n of a)if(n.target===this.getWrapper()){const r=`${n.contentRect.height}px`;document.documentElement.style.setProperty("--apkt-footer-height",r)}}),this.resizeObserver.observe(this.getWrapper())}render(){return e`
...
`;var C=function(t,a,n,r){var s=arguments.length,i=s<3?a:r===null?r=Object.getOwnPropertyDescriptor(a,n):r,o;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(t,a,n,r);else for(var c=t.length-1;c>=0;c--)(o=t[c])&&(i=(s<3?o(i):s>3?o(a,n,i):o(a,n))||i);return s>3&&i&&Object.defineProperty(a,n,i),i};const S=4;let h=class extends f{constructor(){super(...arguments),this.walletImages=[]}render(){const a=this.walletImages.length<S;return e`${this.walletImages.slice(0,S).map(({src:n,walletName:r})=>e`
          <wui-wallet-image
            size="sm"
            imageSrc=${n}
            name=${v(r)}
          ></wui-wallet-image>
        `)}
    ${a?[...Array(S-this.walletImages.length)].map(()=>e` <wui-wallet-image size="sm" name=""></wui-wallet-image>`):null} `}};h.styles=[k,R];C([w({type:Array})],h.prototype,"walletImages",void 0);h=C([b("wui-all-wallets-image")],h);const E=g`
  :host {
    width: 100%;
  }
...
`;var m=function(t,a,n,r){var s=arguments.length,i=s<3?a:r===null?r=Object.getOwnPropertyDescriptor(a,n):r,o;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(t,a,n,r);else for(var c=t.length-1;c>=0;c--)(o=t[c])&&(i=(s<3?o(i):s>3?o(a,n,i):o(a,n))||i);return s>3&&i&&Object.defineProperty(a,n,i),i};const z={eip155:"ethereum",solana:"solana",bip122:"bitcoin",polkadot:void 0,cosmos:void 0,sui:void 0,stacks:void 0,ton:"ton",tron:"tron"};let l=class extends f{constructor(){super(...arguments),this.walletImages=[],this.imageSrc="",this.name="",this.size="md",this.tabIdx=void 0,this.namespaces=[],this.disabled=!1,this.showAllWallets=!1,this.loading=!1,this.loadingSpinnerColor="accent-100"}render(){return this.dataset.size=this.size,e`
      <button
    ...
    `}templateNamespaces(){return this.namespaces?.length?e`<wui-flex alignItems="center" gap="0">
        ${this.namespaces.map((a,n)=>e`<wui-flex
              alignItems="center"
