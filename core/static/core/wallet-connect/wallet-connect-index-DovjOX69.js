import{aN as C,aO as E,aP as P,aQ as h,aR as b,aS as v,aT as l,aV as O,be as d,bi as g,aY as S,b4 as x,az as R,aA as $}from"./wallet-connect.js";import{U as T}from"./wallet-connect-index-CogVilYf.js";import"./wallet-connect-index-DDHBnAC-.js";const L=C`
  :host {
    position: relative;
...
`;var f=function(i,t,e,n){var s=arguments.length,o=s<3?t:n===null?n=Object.getOwnPropertyDescriptor(t,e):n,r;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(i,t,e,n);else for(var a=i.length-1;a>=0;a--)(r=i[a])&&(o=(s<3?r(o):s>3?r(t,e,o):r(t,e))||o);return s>3&&o&&Object.defineProperty(t,e,o),o},w;let u=w=class extends v{firstUpdated(){this.startOTPTimeout()}disconnectedCallback(){clearTimeout(this.OTPTimeout)}constructor(){super(),this.loading=!1,this.timeoutTimeLeft=g.getTimeToNextEmailLogin(),this.error="",this.otp="",this.email=S.state.data?.email,this.authConnector=x.getAuthConnector()}render(){if(!this.email)throw new Error("w3m-email-otp-widget: No email provided");const t=!!this.timeoutTimeLeft,e=this.getFooterLabels(t);return l`
      <wui-flex
