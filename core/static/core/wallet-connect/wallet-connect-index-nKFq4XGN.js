import{aN as c,aO as h,aP as b,aQ as n,aR as m,aS as x,aW as $,aT as r}from"./wallet-connect.js";import{e as f,n as g}from"./wallet-connect-ref-m3XXzk8j.js";const w=c`
  :host {
    position: relative;
    width: 100%;
    display: inline-flex;
...
`;var i=function(t,a,s,u){var p=arguments.length,o=p<3?a:u===null?u=Object.getOwnPropertyDescriptor(a,s):u,l;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(t,a,s,u);else for(var d=t.length-1;d>=0;d--)(l=t[d])&&(o=(p<3?l(o):p>3?l(a,s,o):l(a,s))||o);return p>3&&o&&Object.defineProperty(a,s,o),o};let e=class extends x{constructor(){super(...arguments),this.inputElementRef=f(),this.disabled=!1,this.loading=!1,this.placeholder="",this.type="text",this.value="",this.size="md"}render(){return r` <div class="wui-input-text-container">
