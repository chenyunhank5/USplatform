...
class UserProfile(models.Model):
    ...
    reset_count_today = models.PositiveIntegerField(default=0)
    reset_count_total = models.PositiveIntegerField(default=0)
    reset_count_date = models.DateField(blank=True, null=True)
